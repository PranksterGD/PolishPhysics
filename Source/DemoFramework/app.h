 ...
 */
 ...
 protected:
    ...
    PolishPhysics::Contact contacts[maxContacts];

    /** Holds the collision data structure for collision detection. */
	PolishPhysics::CollisionData cData;

    /** Holds the contact resolver. */
	PolishPhysics::ContactResolver resolver;
    ...
    virtual void updateObjects(PolishPhysics::Precision duration) = 0;
